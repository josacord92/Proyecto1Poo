 ...
 * @author Jose
 */
public class Hercules extends Heroe {
    
    public static double costo = 1000;
    public static int nivelAparicion = 2;
    ...
    setNombre("Hercules -ID: "+getID());   //Nombre del Personaje
    setNivel(1);                       //Nivel de fuerza Con El Que Se Crea El Guerrero - Inicia en nivel 1
    setCantidadGolpesPorUnidadTiempo(800);
    setVida(1000);
    }
